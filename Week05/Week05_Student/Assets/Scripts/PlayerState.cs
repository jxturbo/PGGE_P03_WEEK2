...
public class PlayerState_ATTACK : PlayerState
{
    ...
    public override void Update()
    {
        ...
        Debug.Log("Current ammo count: " + mPlayer.mAmunitionCount + ", In Magazine: " + mPlayer.mBulletsInMagazine);
...
public class PlayerState_RELOAD : PlayerState
{
    ...
    {
        // For Student ----------------------------------------------------------//
        // Implement the logic of reloading. 
        //-----------------------------------------------------------------------//
        // Hint:
        //-----------------------------------------------------------------------//
        // Reloading happens for a fixed duration of time.
        // After the reloading is completed the player should go 
        // back to the MOVEMENT state. Why MOVEMENT state and why not
        // ATTACK state?
        // Discuss in class and complete the section.
        dt += Time.deltaTime;
        if (dt >= ReloadTime)
        {
            mPlayer.mFsm.SetCurrentState((int)PlayerStateType.MOVEMENT);
